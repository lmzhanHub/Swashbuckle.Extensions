...
namespace Swashbuckle.Swagger
{
    public static class ApiDescriptionExtensions
    {
        ...
        public static bool IsIgnoreController(this ApiDescription apiDescription)
        {
            return apiDescription.ActionDescriptor.ControllerDescriptor.GetCustomAttributes<SwaggerIgnoreAttribute>().Any();
        }
