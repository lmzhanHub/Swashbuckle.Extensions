...
namespace Swashbuckle.Swagger.XmlComments
{
    public class ApplyXmlActionComments : IOperationFilter
    {
        ...
        private static string ApplyControllerName(XPathNavigator controllerNode)
        {
            ...
            var summaryNode = controllerNode.SelectSingleNode(SummaryXPath);
            if (summaryNode != null)
                controllerName = summaryNode.InnerXml;
            return controllerName;
        }
