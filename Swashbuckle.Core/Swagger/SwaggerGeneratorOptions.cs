...
namespace Swashbuckle.Swagger
{
    public class SwaggerGeneratorOptions
    {
        public SwaggerGeneratorOptions(
            ...
            Func<string, string> relativePathResolver = null,
            Func<string, bool> ignoreParamters=null,
            ...
            )
        {
            ...
            IgnoreParamters = ignoreParamters;
            IgnoreControllers = ignoreControllers;
        }
        ...
        public Func<string, string> RelativePathResolver { get; private set; }

        public Func<string,bool> IgnoreParamters { get; private set; }

        public bool IgnoreControllers { get; private set; }
