...
namespace Swashbuckle.Application
{
    public class SwaggerDocsConfig
    {
        ...
        private Func<string,string> _relativePathResolver;
        private Func<HttpRequestMessage, string> _rootUrlResolver;
        private Func<string, bool> _ignoreParamters;
        private bool _ignoreController;
        ...
        public void ResolverRelativePath(Func<string, string> relativePathResolver)
        {
        ...
        public void IgnoreParamters(Func<string,bool> ignoreParamters)
        {
            _ignoreParamters = ignoreParamters;
        }

        public void IgnoreControllers()
        {
        ...
        internal ISwaggerProvider GetSwaggerProvider(HttpRequestMessage swaggerRequest)
        {
            ...
            var options = new SwaggerGeneratorOptions(
                ...
                relativePathResolver: _relativePathResolver,
                ignoreParamters: _ignoreParamters,
                ignoreControllers: _ignoreController
            );
